<!DOCTYPE html>
	...
	<!-- Simple Line Icons -->
	<link rel="stylesheet" href="${basePath}/static/css/simple-line-icons.css">
	<!-- Bootstrap  -->
			...
			<div class="row">
				<nav class="navbar navbar-default navbar-fixed-top">
					<div class="navbar-header">
						...
						<a class="navbar-brand" href="index.ftl">Ucaner.</a> 
					</div>
	...
	<section id="fh5co-home" data-section="home" style="background-image: url(${basePath}/static/images/full_image_4.jpg);" data-stellar-background-ratio="0.5">
				...
				<div class="text-inner">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center">
							<h1 class="animate-box"><span class="big">You</span> <br><span>are</span> <br><span class="medium">What</span><br><span>you</span> <br> <span class="medium">want to be.</span></h1>
							<h2 class="animate-box">勿忘初心 方得始终 <a href="#" target="_blank" title="Free HTML5 Bootstrap Templates" class="fh5co-link">Jason</a></h2>
							<!-- <div class="call-to-action">
								<a href="#" class="demo animate-box"><i class="icon-power"></i> Demo</a>
								<a href="#" class="download animate-box"><i class="icon-download"></i> 安以北往南</a>
							</div> -->
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="fh5co-portfolio animate-box">
							<a href="#">
								<div class="portfolio-entry" style="background-image: url(${basePath}/static/images/portfolio-1.jpg);">
									<div class="desc">
					...
					<div class="col-md-4">
						<div class="fh5co-portfolio animate-box">
							<a href="#">
								<div class="portfolio-entry" style="background-image: url(${basePath}/static/images/portfolio-2.jpg);">
									<div class="desc">
										<p>Solid Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									</div>
								</div>
					...
					<div class="col-md-4">
						<div class="fh5co-portfolio animate-box">
							<a href="#">
								<div class="portfolio-entry" style="background-image: url(${basePath}/static/images/portfolio-3.jpg);">
									<div class="desc">
										<p>Solid Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									</div>
								</div>
					...
					<div class="col-md-4">
						<div class="fh5co-portfolio animate-box">
							<a href="#">
								<div class="portfolio-entry" style="background-image: url(${basePath}/static/images/portfolio-4.jpg);">
									<div class="desc">
										<p>Solid Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									</div>
								</div>
					...
					<div class="col-md-4">
						<div class="fh5co-portfolio animate-box">
							<a href="#">
								<div class="portfolio-entry" style="background-image: url(${basePath}/static/images/portfolio-5.jpg);">
									<div class="desc">
										<p>Solid Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									</div>
								</div>
					...
					<div class="col-md-4">
						<div class="fh5co-portfolio animate-box">
							<a href="#">
								<div class="portfolio-entry" style="background-image: url(${basePath}/static/images/portfolio-6.jpg);">
									<div class="desc">
										<p>Solid Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									</div>
								</div>
					...
					<div class="col-md-4">
						<div class="fh5co-portfolio animate-box">
							<a href="#">
								<div class="portfolio-entry" style="background-image: url(${basePath}/static/images/portfolio-7.jpg);">
									<div class="desc">
										<p>Solid Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									</div>
								</div>
					...
					<div class="col-md-4">
						<div class="fh5co-portfolio animate-box">
							<a href="#">
								<div class="portfolio-entry" style="background-image: url(${basePath}/static/images/portfolio-8.jpg);">
									<div class="desc">
										<p>Solid Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									</div>
								</div>
					...
					<div class="col-md-4">
						<div class="fh5co-portfolio animate-box">
							<a href="#">
								<div class="portfolio-entry" style="background-image: url(${basePath}/static/images/portfolio-9.jpg);">
									<div class="desc">
										<p>Solid Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
									</div>
								</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="testimony-entry animate-box">
						...
						<div class="author-img" style="background-image: url(${basePath}/static/images/user-1.jpg);"></div>
					...
					<div class="testimony-entry animate-box">
						...
						<div class="author-img" style="background-image: url(${basePath}/static/images/user-2.jpg);"></div>
						<span class="user">Randy White <br> <small>Bloger, Analyst</small></span>
					</div>
					...
					<div class="testimony-entry animate-box">
						...
						<div class="author-img" style="background-image: url(${basePath}/static/images/user-4.jpg);"></div>
						<span class="user">Randy White <br> <small>Bloger, Analyst</small></span>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="testimony-entry animate-box">
						...
						<div class="author-img" style="background-image: url(${basePath}/static/images/user-3.jpg);"></div>
						<span class="user">Randy White <br> <small>Bloger, Analyst</small></span>
					</div>
					...
					<div class="testimony-entry animate-box">
						...
						<div class="author-img" style="background-image: url(${basePath}/static/images/user-5.jpg);"></div>
						<span class="user">Randy White <br> <small>Bloger, Analyst</small></span>
					</div>
				...
				<div class="col-md-4">
					<div class="testimony-entry animate-box">
						...
						<div class="author-img" style="background-image: url(${basePath}/static/images/user-6.jpg);"></div>
						<span class="user">Randy White <br> <small>Bloger, Analyst</small></span>
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-4 animate-box blog">
						<a href="#" class="entry">
							<div class="blog-bg" style="background-image: url(${basePath}/static/images/blog-1.jpg);">
								<div class="date">
									<span>03</span>
									<small>Mar</small>
								</div>
					...
					<div class="col-md-4 animate-box blog">
						<a href="#" class="entry">
							<div class="blog-bg" style="background-image: url(${basePath}/static/images/blog-2.jpg);">
								<div class="date">
									<span>01</span>
									<small>Mar</small>
								</div>
					...
					<div class="col-md-4 animate-box blog">
						<a href="#" class="entry">
							<div class="blog-bg" style="background-image: url(${basePath}/static/images/blog-3.jpg);">
								<div class="date">
									<span>28</span>
									<small>Feb</small>
								</div>
	...
	<div id="fh5co-footer" role="contentinfo">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-12">
					<p class="copy-right">&copy; 2017 JasonInternational. All Rights Reserved. 
					<br>You are what you want to be. 
					<a href="http://www.ucaner.cn/" target="_blank" title="Ucaner"><font color="red">Ucaner</font></a> 
					<a href="http://www.ucaner.cn/" title="Ucaner" target="_blank">Ucaner</a>	
					</p>
				</div>
			</div>
		</div>
