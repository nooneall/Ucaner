...
import cn.ucaner.tools.log.AbstractLocationAwareLog;
...
public class Log4jLog extends AbstractLocationAwareLog {
	...
	// ------------------------------------------------------------------------- Log
	@Override
	public void log(cn.ucaner.tools.log.level.Level level, String format, Object... arguments) {
		log(level, null, format, arguments);
	}
	
	@Override
	public void log(cn.ucaner.tools.log.level.Level level, Throwable t, String format, Object... arguments) {
		this.log(FQCN, level, t, format, arguments);
	}
	
	@Override
	public void log(String fqcn, cn.ucaner.tools.log.level.Level level, Throwable t, String format, Object... arguments) {
		Level log4jLevel;
		switch (level) {
			case TRACE:
